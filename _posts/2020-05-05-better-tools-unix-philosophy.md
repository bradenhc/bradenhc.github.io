...
Our `channel` array now holds two file descriptors: `channel[0]` holds the _read_ end of the pipe, and `channel[1]` holds the _write_ end. Once we have the channel setup, we can spawn a child process:
